        ...
        <AppearanceProvider appearance={appearance} variant={appearanceVariant}>
            <Dialog
                ...
                <p>
                    ...
                    parameters, see the{" "}
                    <a href="https://github.com/mihaip/infinite-mac/blob/main/src/defs/run-def.ts#L59">
                ...
                <ul className="EmbedDocs-MessageList">
                    ...
                    <li>
                        ...
                        . See{" "}
                        <a href="https://github.com/mihaip/infinite-mac/blob/main/src/emulator/common/key-codes.ts">
                            the source code
                        </a>{" "}
