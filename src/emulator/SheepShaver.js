...
var ASM_CONSTS = {
 ...
 186810: () => { return workerApi.acquireInputLock(); },  
 186851: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 186940: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 187030: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 187117: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 187201: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 187288: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 187372: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.useMouseDeltasFlagAddr); },  
 187463: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.useMouseDeltasAddr); },  
 187550: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 187635: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 187715: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 187796: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.ethernetInterruptFlagAddr); },  
 187890: () => { workerApi.releaseInputLock(); },  
 187924: () => { workerApi.sleep(0.001); },  
 187952: ($0) => { workerApi.setClipboardText(UTF8ToString($0)); },  
 188002: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 188053: ($0) => { workerApi.disks.close($0); },  
 188084: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 188133: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); },  
 188183: ($0) => { return workerApi.disks.size($0); },  
 188220: ($0) => { return workerApi.disks.isMediaPresent($0); },  
 188267: ($0) => { return workerApi.disks.isFixedDisk($0); },  
 188311: ($0) => { workerApi.disks.eject($0); }
};
