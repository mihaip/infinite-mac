...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('SheepShaver.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('SheepShaver.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  186400: () => { return workerApi.idleWait(); },  
 186433: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 186469: () => { workerApi.blit(0, 0); },  
 186495: ($0, $1) => { workerApi.blit($0, $1); },  
 186523: () => { return workerApi.etherSeed(); },  
 186557: ($0) => { workerApi.etherInit(UTF8ToString($0)); },  
 186600: ($0, $1, $2) => { workerApi.etherWrite(UTF8ToString($0), $1, $2); },  
 186652: ($0) => { return workerApi.etherRead($0, 1514); },  
 186694: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 186730: () => { return workerApi.audioBufferSize(); },  
 186770: ($0, $1, $2) => { workerApi.didOpenAudio($0, $1, $2); },  
 186810: ($0) => { return workerApi.acquireInputLock($0); },  
 186853: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 186942: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 187032: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 187119: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 187203: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 187290: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 187374: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.useMouseDeltasFlagAddr); },  
 187465: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.useMouseDeltasAddr); },  
 187552: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 187637: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 187717: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 187798: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.ethernetInterruptFlagAddr); },  
 187892: () => { workerApi.releaseInputLock(); },  
 187926: () => { workerApi.sleep(0.001); },  
 187954: ($0) => { workerApi.setClipboardText(UTF8ToString($0)); },  
 188004: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 188055: ($0) => { workerApi.disks.close($0); },  
 188086: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 188135: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); },  
 188185: ($0) => { return workerApi.disks.size($0); },  
 188222: ($0) => { return workerApi.disks.isMediaPresent($0); },  
 188269: ($0) => { return workerApi.disks.isFixedDisk($0); },  
 188313: ($0) => { workerApi.disks.eject($0); }
};
function getClipboardText() { const clipboardText = workerApi.getClipboardText(); if (!clipboardText?.length) { return 0; } const clipboardTextLength = lengthBytesUTF8(clipboardText) + 1; const clipboardTextCstr = _malloc(clipboardTextLength); stringToUTF8(clipboardText, clipboardTextCstr, clipboardTextLength); return clipboardTextCstr; }
