...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('minivmac-IIx.wasm');
  }
...
var ASM_CONSTS = {
  80708: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); },  
 80758: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 80807: ($0) => { return workerApi.disks.size($0); },  
 80844: ($0) => { workerApi.sleep($0); },  
 80869: ($0) => { workerApi.disks.close($0); },  
 80900: () => { workerApi.blit(0, 0); },  
 80926: ($0, $1, $2, $3, $4, $5) => { workerApi.blit($0, $1, {top: $2, left: $3, bottom: $4, right: $5}); },  
 80998: ($0, $1) => { return workerApi.enqueueAudio($0, $1); },  
 81041: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 81092: ($0) => { workerApi.disks.close($0); },  
 81123: () => { return workerApi.acquireInputLock(); },  
 81164: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 81253: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 81343: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 81430: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 81517: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 81602: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 81682: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 81763: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedFlagAddr); },  
 81845: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedAddr); },  
 81923: () => { workerApi.releaseInputLock(); },  
 81957: ($0, $1, $2) => { workerApi.didOpenAudio($0, $1, $2); },  
 81997: ($0, $1) => { workerApi.didOpenVideo($0, $1); }
};
