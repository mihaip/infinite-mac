...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('minivmac-512Ke.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('minivmac-512Ke.wasm', import.meta.url).href;
}
...
// Begin JS library code
  ...
  const readEmAsmArgs = (sigPtr, buf) => {
      ...
      while (ch = HEAPU8[sigPtr++]) {
        const chr = String.fromCharCode(ch);
        const validChars = ['d', 'f', 'i', 'p'];
...
var ASM_CONSTS = {
  78468: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); },  
 78518: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 78567: ($0) => { return workerApi.disks.size($0); },  
 78604: ($0) => { workerApi.sleep($0); },  
 78629: ($0) => { workerApi.disks.close($0); },  
 78660: () => { workerApi.blit(0, 0); },  
 78686: ($0, $1, $2, $3, $4, $5) => { workerApi.blit($0, $1, {top: $2, left: $3, bottom: $4, right: $5}); },  
 78758: ($0, $1) => { return workerApi.enqueueAudio($0, $1); },  
 78801: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 78852: ($0) => { workerApi.disks.close($0); },  
 78883: () => { return workerApi.acquireInputLock(); },  
 78924: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 79013: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 79103: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 79190: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 79277: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 79362: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 79442: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 79523: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedFlagAddr); },  
 79605: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedAddr); },  
 79683: () => { workerApi.releaseInputLock(); },  
 79717: ($0, $1, $2) => { workerApi.didOpenAudio($0, $1, $2); },  
 79757: ($0, $1) => { workerApi.didOpenVideo($0, $1); }
};
...
let __emscripten_stack_alloc = makeInvalidEarlyAccess('__emscripten_stack_alloc');
var _emscripten_stack_get_current = makeInvalidEarlyAccess('_emscripten_stack_get_current');
let ___cxa_increment_exception_refcount = makeInvalidEarlyAccess('___cxa_increment_exception_refcount');
