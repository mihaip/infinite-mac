...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('minivmac-128K.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('minivmac-128K.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  78484: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); },  
 78534: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 78583: ($0) => { return workerApi.disks.size($0); },  
 78620: ($0) => { workerApi.sleep($0); },  
 78645: ($0) => { workerApi.disks.close($0); },  
 78676: () => { workerApi.blit(0, 0); },  
 78702: ($0, $1, $2, $3, $4, $5) => { workerApi.blit($0, $1, {top: $2, left: $3, bottom: $4, right: $5}); },  
 78774: ($0, $1) => { return workerApi.enqueueAudio($0, $1); },  
 78817: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 78868: ($0) => { workerApi.disks.close($0); },  
 78899: () => { return workerApi.acquireInputLock(); },  
 78940: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 79029: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 79119: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 79206: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 79293: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 79378: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 79458: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 79539: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedFlagAddr); },  
 79621: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.speedAddr); },  
 79699: () => { workerApi.releaseInputLock(); },  
 79733: ($0, $1, $2) => { workerApi.didOpenAudio($0, $1, $2); },  
 79773: ($0, $1) => { workerApi.didOpenVideo($0, $1); }
};
