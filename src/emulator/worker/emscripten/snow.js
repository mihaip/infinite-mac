...
function _js_inspector_call(ptr, length, source, returning, handle, reference, resourceType, pc) {
...
function _js_inspector_tick(ptr, length) {
...
var wasmImports = {
  ...
  /** @export */ js_inspector_call: _js_inspector_call,
  /** @export */ js_inspector_initialized: _js_inspector_initialized,
  /** @export */ js_inspector_tick: _js_inspector_tick,
