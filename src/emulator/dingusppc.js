...
var ASM_CONSTS = {
  124544: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 124591: () => { return workerApi.acquireInputLock(); },  
 124632: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 124721: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 124811: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 124895: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 124979: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 125064: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 125144: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 125225: () => { workerApi.releaseInputLock(); },  
 125259: () => { workerApi.sleep(0); },  
 125283: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 125327: () => { return workerApi.audioBufferSize(); },  
 125367: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 125403: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 125439: ($0, $1) => { workerApi.blit($0, $1); },  
 125467: () => { workerApi.blit(0, 0); },  
 125493: ($0, $1) => { workerApi.blit($0, $1); },  
 125521: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 125572: ($0) => { workerApi.disks.close($0); },  
 125603: ($0) => { return workerApi.disks.size($0); },  
 125640: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 125689: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
