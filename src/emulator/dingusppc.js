...
var ASM_CONSTS = {
  148096: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 148143: () => { return workerApi.acquireInputLock(); },  
 148184: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 148273: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 148363: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 148453: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 148537: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 148621: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 148708: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 148795: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 148880: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 148960: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 149041: () => { workerApi.releaseInputLock(); },  
 149075: () => { workerApi.sleep(0); },  
 149099: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 149143: () => { return workerApi.audioBufferSize(); },  
 149183: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 149219: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 149255: ($0, $1) => { workerApi.blit($0, $1); },  
 149283: ($0, $1) => { workerApi.blit($0, $1); },  
 149311: () => { workerApi.blit(0, 0); },  
 149337: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 149388: ($0) => { workerApi.disks.close($0); },  
 149419: ($0) => { return workerApi.disks.size($0); },  
 149456: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 149505: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
