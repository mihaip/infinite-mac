...
var ASM_CONSTS = {
  150272: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 150319: () => { return workerApi.acquireInputLock(); },  
 150360: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 150449: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 150539: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 150629: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 150713: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 150797: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 150884: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 150971: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 151056: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 151136: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 151217: () => { workerApi.releaseInputLock(); },  
 151251: () => { workerApi.sleep(0); },  
 151275: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 151319: () => { return workerApi.audioBufferSize(); },  
 151359: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 151395: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 151431: ($0, $1) => { workerApi.blit($0, $1); },  
 151459: ($0, $1) => { workerApi.blit($0, $1); },  
 151487: () => { workerApi.blit(0, 0); },  
 151513: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 151564: ($0) => { workerApi.disks.close($0); },  
 151595: ($0) => { return workerApi.disks.size($0); },  
 151632: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 151681: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
