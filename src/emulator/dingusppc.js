...
var ASM_CONSTS = {
  180752: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 180799: () => { return workerApi.acquireInputLock(); },  
 180840: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 180929: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 181019: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 181109: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 181193: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 181277: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 181364: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 181451: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 181536: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 181616: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 181697: () => { workerApi.releaseInputLock(); },  
 181731: () => { workerApi.sleep(0); },  
 181755: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 181799: () => { return workerApi.audioBufferSize(); },  
 181839: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 181875: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 181911: ($0, $1) => { workerApi.blit($0, $1); },  
 181939: ($0, $1) => { workerApi.blit($0, $1); },  
 181967: () => { workerApi.blit(0, 0); },  
 181993: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 182044: ($0) => { workerApi.disks.close($0); },  
 182075: ($0) => { return workerApi.disks.size($0); },  
 182112: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 182161: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
