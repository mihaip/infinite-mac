...
var ASM_CONSTS = {
  147520: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 147567: () => { return workerApi.acquireInputLock(); },  
 147608: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 147697: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 147787: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 147877: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 147961: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 148045: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 148132: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 148219: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 148304: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 148384: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 148465: () => { workerApi.releaseInputLock(); },  
 148499: () => { workerApi.sleep(0); },  
 148523: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 148567: () => { return workerApi.audioBufferSize(); },  
 148607: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 148643: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 148679: ($0, $1) => { workerApi.blit($0, $1); },  
 148707: ($0, $1) => { workerApi.blit($0, $1); },  
 148735: () => { workerApi.blit(0, 0); },  
 148761: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 148812: ($0) => { workerApi.disks.close($0); },  
 148843: ($0) => { return workerApi.disks.size($0); },  
 148880: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 148929: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
