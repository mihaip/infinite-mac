...
var ASM_CONSTS = {
  174064: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 174111: () => { return workerApi.acquireInputLock(); },  
 174152: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 174241: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 174331: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 174421: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 174505: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 174589: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 174676: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 174763: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 174848: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 174928: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 175009: () => { workerApi.releaseInputLock(); },  
 175043: () => { workerApi.sleep(0); },  
 175067: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 175111: () => { return workerApi.audioBufferSize(); },  
 175151: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 175187: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 175223: ($0, $1) => { workerApi.blit($0, $1); },  
 175251: ($0, $1) => { workerApi.blit($0, $1); },  
 175279: () => { workerApi.blit(0, 0); },  
 175305: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 175356: ($0) => { workerApi.disks.close($0); },  
 175387: ($0) => { return workerApi.disks.size($0); },  
 175424: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 175473: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
