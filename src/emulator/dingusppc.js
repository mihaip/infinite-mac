...
var ASM_CONSTS = {
  124608: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 124655: () => { return workerApi.acquireInputLock(); },  
 124696: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 124785: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 124875: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 124959: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 125043: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 125128: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 125208: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 125289: () => { workerApi.releaseInputLock(); },  
 125323: () => { workerApi.sleep(0); },  
 125347: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 125391: () => { return workerApi.audioBufferSize(); },  
 125431: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 125467: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 125503: ($0, $1) => { workerApi.blit($0, $1); },  
 125531: () => { workerApi.blit(0, 0); },  
 125557: ($0, $1) => { workerApi.blit($0, $1); },  
 125585: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 125636: ($0) => { workerApi.disks.close($0); },  
 125667: ($0) => { return workerApi.disks.size($0); },  
 125704: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 125753: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
