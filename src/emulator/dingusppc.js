...
var ASM_CONSTS = {
  107408: () => { return workerApi.acquireInputLock(); },  
 107449: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 107538: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 107628: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 107712: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 107796: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 107881: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 107961: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 108042: () => { workerApi.releaseInputLock(); },  
 108076: () => { workerApi.sleep(0); },  
 108100: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 108144: () => { return workerApi.audioBufferSize(); },  
 108184: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 108220: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 108256: ($0, $1) => { workerApi.blit($0, $1); },  
 108284: () => { workerApi.blit(0, 0); },  
 108310: ($0, $1) => { workerApi.blit($0, $1); },  
 108338: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 108389: ($0) => { workerApi.disks.close($0); },  
 108420: ($0) => { return workerApi.disks.size($0); },  
 108457: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 108506: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
