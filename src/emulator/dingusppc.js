...
var ASM_CONSTS = {
  122752: () => { return workerApi.acquireInputLock(); },  
 122793: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 122882: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 122972: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 123056: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 123140: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 123225: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 123305: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 123386: () => { workerApi.releaseInputLock(); },  
 123420: () => { workerApi.sleep(0); },  
 123444: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 123488: () => { return workerApi.audioBufferSize(); },  
 123528: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 123564: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 123600: ($0, $1) => { workerApi.blit($0, $1); },  
 123628: () => { workerApi.blit(0, 0); },  
 123654: ($0, $1) => { workerApi.blit($0, $1); },  
 123682: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 123733: ($0) => { workerApi.disks.close($0); },  
 123764: ($0) => { return workerApi.disks.size($0); },  
 123801: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 123850: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
