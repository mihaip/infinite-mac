...
var ASM_CONSTS = {
  148416: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 148463: () => { return workerApi.acquireInputLock(); },  
 148504: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 148593: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 148683: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 148773: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 148857: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 148941: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 149028: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 149115: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 149200: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 149280: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 149361: () => { workerApi.releaseInputLock(); },  
 149395: () => { workerApi.sleep(0); },  
 149419: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 149463: () => { return workerApi.audioBufferSize(); },  
 149503: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 149539: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 149575: ($0, $1) => { workerApi.blit($0, $1); },  
 149603: ($0, $1) => { workerApi.blit($0, $1); },  
 149631: () => { workerApi.blit(0, 0); },  
 149657: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 149708: ($0) => { workerApi.disks.close($0); },  
 149739: ($0) => { return workerApi.disks.size($0); },  
 149776: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 149825: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
