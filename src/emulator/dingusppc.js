...
var ASM_CONSTS = {
  148480: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 148527: () => { return workerApi.acquireInputLock(); },  
 148568: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 148657: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 148747: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 148837: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 148921: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 149005: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 149092: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 149179: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 149264: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 149344: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 149425: () => { workerApi.releaseInputLock(); },  
 149459: () => { workerApi.sleep(0); },  
 149483: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 149527: () => { return workerApi.audioBufferSize(); },  
 149567: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 149603: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 149639: ($0, $1) => { workerApi.blit($0, $1); },  
 149667: ($0, $1) => { workerApi.blit($0, $1); },  
 149695: () => { workerApi.blit(0, 0); },  
 149721: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 149772: ($0) => { workerApi.disks.close($0); },  
 149803: ($0) => { return workerApi.disks.size($0); },  
 149840: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 149889: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
