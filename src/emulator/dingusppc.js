...
var ASM_CONSTS = {
  110960: () => { return workerApi.acquireInputLock(); },  
 111001: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 111090: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 111180: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 111264: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 111348: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 111433: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 111513: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 111594: () => { workerApi.releaseInputLock(); },  
 111628: () => { workerApi.sleep(0); },  
 111652: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 111696: () => { return workerApi.audioBufferSize(); },  
 111736: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 111772: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 111808: ($0, $1) => { workerApi.blit($0, $1); },  
 111836: () => { workerApi.blit(0, 0); },  
 111862: ($0, $1) => { workerApi.blit($0, $1); },  
 111890: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 111941: ($0) => { workerApi.disks.close($0); },  
 111972: ($0) => { return workerApi.disks.size($0); },  
 112009: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 112058: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
