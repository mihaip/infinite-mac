...
var ASM_CONSTS = {
  124272: () => { return workerApi.acquireInputLock(); },  
 124313: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 124402: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 124492: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 124576: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 124660: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 124745: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 124825: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 124906: () => { workerApi.releaseInputLock(); },  
 124940: () => { workerApi.sleep(0); },  
 124964: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 125008: () => { return workerApi.audioBufferSize(); },  
 125048: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 125084: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 125120: ($0, $1) => { workerApi.blit($0, $1); },  
 125148: () => { workerApi.blit(0, 0); },  
 125174: ($0, $1) => { workerApi.blit($0, $1); },  
 125202: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 125253: ($0) => { workerApi.disks.close($0); },  
 125284: ($0) => { return workerApi.disks.size($0); },  
 125321: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 125370: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
