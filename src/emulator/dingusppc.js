...
var ASM_CONSTS = {
  180560: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 180607: () => { return workerApi.acquireInputLock(); },  
 180648: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 180737: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 180827: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 180917: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 181001: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 181085: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 181172: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 181259: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 181344: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 181424: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 181505: () => { workerApi.releaseInputLock(); },  
 181539: () => { workerApi.sleep(0); },  
 181563: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 181607: () => { return workerApi.audioBufferSize(); },  
 181647: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 181683: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 181719: ($0, $1) => { workerApi.blit($0, $1); },  
 181747: ($0, $1) => { workerApi.blit($0, $1); },  
 181775: () => { workerApi.blit(0, 0); },  
 181801: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 181852: ($0) => { workerApi.disks.close($0); },  
 181883: ($0) => { return workerApi.disks.size($0); },  
 181920: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 181969: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
