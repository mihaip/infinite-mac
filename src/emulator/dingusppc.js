...
var ASM_CONSTS = {
 ...
 147313: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 147403: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 147493: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 147577: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 147661: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 147748: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 147835: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 147920: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 148000: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 148081: () => { workerApi.releaseInputLock(); },  
 148115: () => { workerApi.sleep(0); },  
 148139: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 148183: () => { return workerApi.audioBufferSize(); },  
 148223: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 148259: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 148295: ($0, $1) => { workerApi.blit($0, $1); },  
 148323: ($0, $1) => { workerApi.blit($0, $1); },  
 148351: () => { workerApi.blit(0, 0); },  
 148377: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 148428: ($0) => { workerApi.disks.close($0); },  
 148459: ($0) => { return workerApi.disks.size($0); },  
 148496: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 148545: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
