...
var ASM_CONSTS = {
  180080: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 180127: () => { return workerApi.acquireInputLock(); },  
 180168: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 180257: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 180347: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 180437: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 180521: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 180605: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 180692: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 180779: () => { workerApi.releaseInputLock(); },  
 180813: () => { workerApi.sleep(0); },  
 180837: () => { return workerApi.acquireInputLock(); },  
 180878: () => { workerApi.releaseInputLock(); },  
 180912: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 180997: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 181077: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 181158: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 181202: () => { return workerApi.audioBufferSize(); },  
 181242: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 181278: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 181314: ($0, $1) => { workerApi.blit($0, $1); },  
 181342: ($0, $1) => { workerApi.blit($0, $1); },  
 181370: () => { workerApi.blit(0, 0); },  
 181396: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 181447: ($0) => { workerApi.disks.close($0); },  
 181478: ($0) => { return workerApi.disks.size($0); },  
 181515: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 181564: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
