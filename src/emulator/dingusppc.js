...
var ASM_CONSTS = {
  153504: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 153551: () => { return workerApi.acquireInputLock(); },  
 153592: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 153681: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 153771: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 153861: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 153945: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 154029: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 154116: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 154203: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 154288: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 154368: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 154449: () => { workerApi.releaseInputLock(); },  
 154483: () => { workerApi.sleep(0); },  
 154507: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 154551: () => { return workerApi.audioBufferSize(); },  
 154591: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 154627: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 154663: ($0, $1) => { workerApi.blit($0, $1); },  
 154691: ($0, $1) => { workerApi.blit($0, $1); },  
 154719: () => { workerApi.blit(0, 0); },  
 154745: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 154796: ($0) => { workerApi.disks.close($0); },  
 154827: ($0) => { return workerApi.disks.size($0); },  
 154864: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 154913: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
