...
var ASM_CONSTS = {
  122160: () => { return workerApi.acquireInputLock(); },  
 122201: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 122290: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 122380: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 122464: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 122548: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 122633: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 122713: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 122794: () => { workerApi.releaseInputLock(); },  
 122828: () => { workerApi.sleep(0); },  
 122852: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 122896: () => { return workerApi.audioBufferSize(); },  
 122936: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 122972: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 123008: ($0, $1) => { workerApi.blit($0, $1); },  
 123036: () => { workerApi.blit(0, 0); },  
 123062: ($0, $1) => { workerApi.blit($0, $1); },  
 123090: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 123141: ($0) => { workerApi.disks.close($0); },  
 123172: ($0) => { return workerApi.disks.size($0); },  
 123209: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 123258: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
