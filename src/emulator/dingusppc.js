...
var ASM_CONSTS = {
  154496: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 154543: () => { return workerApi.acquireInputLock(); },  
 154584: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 154673: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 154763: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 154853: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 154937: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 155021: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 155108: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 155195: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 155280: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 155360: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 155441: () => { workerApi.releaseInputLock(); },  
 155475: () => { workerApi.sleep(0); },  
 155499: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 155543: () => { return workerApi.audioBufferSize(); },  
 155583: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 155619: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 155655: ($0, $1) => { workerApi.blit($0, $1); },  
 155683: ($0, $1) => { workerApi.blit($0, $1); },  
 155711: () => { workerApi.blit(0, 0); },  
 155737: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 155788: ($0) => { workerApi.disks.close($0); },  
 155819: ($0) => { return workerApi.disks.size($0); },  
 155856: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 155905: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
