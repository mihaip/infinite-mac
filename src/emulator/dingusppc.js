...
var ASM_CONSTS = {
  181296: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 181343: () => { return workerApi.acquireInputLock(); },  
 181384: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 181473: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 181563: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 181653: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 181737: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 181821: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 181908: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 181995: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 182080: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 182160: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 182241: () => { workerApi.releaseInputLock(); },  
 182275: () => { workerApi.sleep(0); },  
 182299: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 182343: () => { return workerApi.audioBufferSize(); },  
 182383: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 182419: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 182455: ($0, $1) => { workerApi.blit($0, $1); },  
 182483: ($0, $1) => { workerApi.blit($0, $1); },  
 182511: () => { workerApi.blit(0, 0); },  
 182537: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 182588: ($0) => { workerApi.disks.close($0); },  
 182619: ($0) => { return workerApi.disks.size($0); },  
 182656: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 182705: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
