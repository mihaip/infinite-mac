...
var ASM_CONSTS = {
  179456: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 179503: () => { return workerApi.acquireInputLock(); },  
 179544: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 179633: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 179723: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 179813: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 179897: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 179981: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 180068: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 180155: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 180240: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 180320: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 180401: () => { workerApi.releaseInputLock(); },  
 180435: () => { workerApi.sleep(0); },  
 180459: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 180503: () => { return workerApi.audioBufferSize(); },  
 180543: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 180579: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 180615: ($0, $1) => { workerApi.blit($0, $1); },  
 180643: ($0, $1) => { workerApi.blit($0, $1); },  
 180671: () => { workerApi.blit(0, 0); },  
 180697: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 180748: ($0) => { workerApi.disks.close($0); },  
 180779: ($0) => { return workerApi.disks.size($0); },  
 180816: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 180865: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
