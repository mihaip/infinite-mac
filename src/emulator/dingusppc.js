...
var ASM_CONSTS = {
  108720: () => { return workerApi.acquireInputLock(); },  
 108761: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 108850: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 108940: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 109024: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 109108: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 109193: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 109273: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 109354: () => { workerApi.releaseInputLock(); },  
 109388: () => { workerApi.sleep(0); },  
 109412: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 109456: () => { return workerApi.audioBufferSize(); },  
 109496: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 109532: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 109568: ($0, $1) => { workerApi.blit($0, $1); },  
 109596: () => { workerApi.blit(0, 0); },  
 109622: ($0, $1) => { workerApi.blit($0, $1); },  
 109650: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 109701: ($0) => { workerApi.disks.close($0); },  
 109732: ($0) => { return workerApi.disks.size($0); },  
 109769: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 109818: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
