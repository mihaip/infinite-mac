...
var ASM_CONSTS = {
  108736: () => { return workerApi.acquireInputLock(); },  
 108777: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 108866: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 108956: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 109040: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 109124: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 109209: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 109289: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 109370: () => { workerApi.releaseInputLock(); },  
 109404: () => { workerApi.sleep(0); },  
 109428: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 109472: () => { return workerApi.audioBufferSize(); },  
 109512: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 109548: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 109584: ($0, $1) => { workerApi.blit($0, $1); },  
 109612: () => { workerApi.blit(0, 0); },  
 109638: ($0, $1) => { workerApi.blit($0, $1); },  
 109666: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 109717: ($0) => { workerApi.disks.close($0); },  
 109748: ($0) => { return workerApi.disks.size($0); },  
 109785: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 109834: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
