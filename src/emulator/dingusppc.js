...
var ASM_CONSTS = {
  108496: () => { return workerApi.acquireInputLock(); },  
 108537: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 108626: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 108716: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 108800: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 108884: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 108969: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 109049: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 109130: () => { workerApi.releaseInputLock(); },  
 109164: () => { workerApi.sleep(0); },  
 109188: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 109232: () => { return workerApi.audioBufferSize(); },  
 109272: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 109308: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 109344: ($0, $1) => { workerApi.blit($0, $1); },  
 109372: () => { workerApi.blit(0, 0); },  
 109398: ($0, $1) => { workerApi.blit($0, $1); },  
 109426: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 109477: ($0) => { workerApi.disks.close($0); },  
 109508: ($0) => { return workerApi.disks.size($0); },  
 109545: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 109594: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
