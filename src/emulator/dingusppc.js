...
var ASM_CONSTS = {
  179904: ($0) => { workerApi.setAbortError(UTF8ToString($0)); },  
 179951: () => { return workerApi.acquireInputLock(); },  
 179992: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 180081: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButton2StateAddr); },  
 180171: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 180261: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 180345: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 180429: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionXAddr); },  
 180516: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionYAddr); },  
 180603: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 180688: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 180768: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 180849: () => { workerApi.releaseInputLock(); },  
 180883: () => { workerApi.sleep(0); },  
 180907: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 180951: () => { return workerApi.audioBufferSize(); },  
 180991: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 181027: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 181063: ($0, $1) => { workerApi.blit($0, $1); },  
 181091: ($0, $1) => { workerApi.blit($0, $1); },  
 181119: () => { workerApi.blit(0, 0); },  
 181145: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 181196: ($0) => { workerApi.disks.close($0); },  
 181227: ($0) => { return workerApi.disks.size($0); },  
 181264: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 181313: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
