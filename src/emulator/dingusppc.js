...
var ASM_CONSTS = {
  123312: () => { return workerApi.acquireInputLock(); },  
 123353: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 123442: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 123532: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 123616: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 123700: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 123785: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 123865: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 123946: () => { workerApi.releaseInputLock(); },  
 123980: () => { workerApi.sleep(0); },  
 124004: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 124048: () => { return workerApi.audioBufferSize(); },  
 124088: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 124124: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 124160: ($0, $1) => { workerApi.blit($0, $1); },  
 124188: () => { workerApi.blit(0, 0); },  
 124214: ($0, $1) => { workerApi.blit($0, $1); },  
 124242: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 124293: ($0) => { workerApi.disks.close($0); },  
 124324: ($0) => { return workerApi.disks.size($0); },  
 124361: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 124410: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
