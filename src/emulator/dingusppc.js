...
var ASM_CONSTS = {
  122672: () => { return workerApi.acquireInputLock(); },  
 122713: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseButtonStateAddr); },  
 122802: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mousePositionFlagAddr); },  
 122892: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaXAddr); },  
 122976: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.mouseDeltaYAddr); },  
 123060: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyEventFlagAddr); },  
 123145: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyCodeAddr); },  
 123225: () => { return workerApi.getInputValue(workerApi.InputBufferAddresses.keyStateAddr); },  
 123306: () => { workerApi.releaseInputLock(); },  
 123340: () => { workerApi.sleep(0); },  
 123364: ($0, $1, $2, $3) => { workerApi.didOpenAudio($0, $1, $2, $3); },  
 123408: () => { return workerApi.audioBufferSize(); },  
 123448: ($0, $1) => { workerApi.enqueueAudio($0, $1); },  
 123484: ($0, $1) => { workerApi.didOpenVideo($0, $1); },  
 123520: ($0, $1) => { workerApi.blit($0, $1); },  
 123548: () => { workerApi.blit(0, 0); },  
 123574: ($0, $1) => { workerApi.blit($0, $1); },  
 123602: ($0) => { return workerApi.disks.open(UTF8ToString($0)); },  
 123653: ($0) => { workerApi.disks.close($0); },  
 123684: ($0) => { return workerApi.disks.size($0); },  
 123721: ($0, $1, $2, $3) => { return workerApi.disks.read($0, $1, $2, $3); },  
 123770: ($0, $1, $2, $3) => { return workerApi.disks.write($0, $1, $2, $3); }
};
