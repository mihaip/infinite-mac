...
const DISKS_BY_DOMAIN: {[domain: string]: EmulatorChunkedFileSpec} = {
    ...
    "macos8.app": {
        ...
        prefetchChunks: [
            ...
            84, 85, 86, 87, 88, 89, 90, 93, 94, 95, 96, 97, 98, 100, 101, 102,
            103, 104, 105, 106, 108, 109, 110, 111, 112, 120, 121, 122, 124,
            126, 127, 128, 129, 130, 131, 132, 133, 140, 141, 142, 143, 144,
            145, 146, 148, 149, 150, 152, 153, 154, 155, 156, 157, 167, 168,
